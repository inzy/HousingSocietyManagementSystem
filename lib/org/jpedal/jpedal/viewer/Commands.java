...
public class Commands {
    ...
    private Object executeMenuBarCommands(final int ID, Object[] args){
        ...
        switch (ID) {
            ...
            case BITMAP:
                ...
                break;
            case IMAGES:
                Images.execute(args, currentGUI, commonValues, decode_pdf);
                break;
            case TEXT:
            ...
            //<start-fx>
            case SEPARATECOVER:
                SeperateCover.execute(args, decode_pdf, properties, currentGUI, commonValues);
                break;
            case EXTRACTTEXT:
    ...
    private void executeExternalCommands(final int ID, Object[] args) {
        ...
        switch (ID) {
            ...
            //<start-fx>
            case DELETE:
                Delete.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case ADD:
                Add.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case SECURITY:
                Security.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case ADDHEADERFOOTER:
                AddHeaderFooter.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case STAMPTEXT:
                StampText.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case STAMPIMAGE:
                StampImage.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case SETCROP:
                SetCrop.execute(args, commonValues, searchFrame, currentGUI, decode_pdf, properties, thumbnails);
                break;
            case NUP:
                Nup.execute(args, commonValues, currentGUI, decode_pdf);
                break;
            case HANDOUTS:
                Handouts.execute(args, currentGUI, commonValues, decode_pdf);
                break;
            case SIGN:
                Sign.execute(args, currentGUI, commonValues, decode_pdf);
                break;
            //<end-fx>
        }
    }
    ...
    protected void openTransferedFile() throws PdfException {
        if (currentGUI.isSingle()) {
            ...
            //<start-fx>
            decode_pdf = OpenFile.openNewMultiplePage(commonValues.getSelectedFile(), currentGUI, commonValues);
            //<end-fx>
        }
