       ...
       // int[] pageH=multiDisplayOptions.getPageH();
              ...
              //  yCord=(int) ((PdfDecoderFX)decode_pdf).getHeight();
                   // System.out.println("y="+yCord+" for page "+getPageNumber());
                    ...
                    ((PdfDecoderFX)decode_pdf).scrollRectToVisible(new Rectangle(0, yCord, (int) pw - 1, (int) ph - 1));
...
//        layersPanel.rescanPdfLayers();
    ...
    protected void setupCenterPanelBackground() {
        ...
        if (!propValue.isEmpty()
            ...
            pageContainer.setStyle("-fx-background-color: #"+Integer.parseInt(propValue)+';');

        } else {

            if (decode_pdf.getDecoderOptions().getDisplayBackgroundColor() != null) {
                pageContainer.setStyle("-fx-background-color: #"+decode_pdf.getDecoderOptions().getDisplayBackgroundColor()+';');
            } else if (decode_pdf.useNewGraphicsMode()) {
                pageContainer.setStyle("-fx-background-color: #555565;");
            } else {
                pageContainer.setStyle("-fx-background-color: #190190190;");
            }
        }
    }
...
//            displayPane.setDividerLocation(startSize);
    ...
    public double getDividerLocation() {
        return center.getDividers().get(0).getPosition();
    }
