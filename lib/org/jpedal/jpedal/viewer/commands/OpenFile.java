...
public class OpenFile {
    ...
    //<start-fx>
    private static MultiViewListener multiViewListener;
    //<end-fx>
                ...
                if (newFile != null) {
                    ...
                    if (!Values.isProcessing()) {
                        ...
                        if (!currentGUI.isSingle()) {
                            OpenFile.openNewMultiplePage(commonValues.getSelectedFile(), currentGUI, commonValues);
                        }
                        //<end-fx>
...
//                    currentGUI.resetNavBar();
    ...
    public static PdfDecoderInt openNewMultiplePage(final String fileName, final GUIFactory currentGUI, final Values commonValues) {
        ...
        final PdfDecoder decode_pdf = new PdfDecoder(true);
         ...
         *
         */
        final JInternalFrame pdf = new JInternalFrame(fileName, true, true, true, true);
        final String s = String.valueOf(startX);
        pdf.setName(s);
        pdf.setSize(250, 250);
        pdf.setVisible(true);
            ...
            if (commonValues.isPDF()) {
                ...
                if (isTiff && JAIHelper.isJAIused()) {
                    try {
                        ...
                        PageNavigator.setTiffHelper(new JAITiffHelper(commonValues.getSelectedFile()));
                    ...
                    final String propValue = properties.getValue("showtiffmessage");
                    final boolean showTiffMessage = isTiff && (!propValue.isEmpty() && propValue.equals("true"));
                    ...
                    if (showTiffMessage) {
                        ...
                        final String str = "<html>Some Tiff images do not display correctly without JAI support turned on.  "
                        ...
                        JOptionPane.showMessageDialog((Container)currentGUI.getFrame(), panel);
                        if (cb.isSelected()) {
    ...
    private static String selectURL( final Values commonValues, final GUISearchWindow searchFrame,
        ...
        if (selectedFile != null ) {
            ...
            if ((selectedFile != null) && (!Values.isProcessing())) {
                ...
                //<start-fx>
                if(!currentGUI.isSingle()) {
                    openNewMultiplePage(commonValues.getSelectedFile(), currentGUI, commonValues);
                }
                //<end-fx>
